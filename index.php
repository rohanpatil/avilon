...
<head>
  <meta charset="utf-8">
  <title>Rui Paani Foundation</title>
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto"><img style=" box-shadow: 2px 2px 2px #3F4C57;" src="/img/logo.jpg" alt="Rui Paani Foundation" /></a></h1>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="/about-paani-foundation.php">About Paani Foundation</a></li>
		  <li><a href="/about-rui.php">About Rui</a></li>
          <li><a href="/rating-system.php">Rating System</a></li>        
          <li><a href="/work-completed.php">Work Completed</a></li>
  ...
  <section id="intro">
    ...
    <div class="intro-text">
      <h2>Welcome to Rui Paani Foundation</h2>
      <a href="/about-rui.php" class="btn-get-started scrollto">About Rui</a>
    </div>
  ...
  <main id="main">
    ...
    ============================-->
    <section id="more-features" class="section-bg" style="display: none;">
      <div class="container">
