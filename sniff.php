...
foreach ($arrURLs as $index => $strURL) {
	...
	if (preg_match('(latinorigin|190.2.154|185.233.185.219|82.214.119.228|tvku|trk555|duplexfx|zoneiptv|audio|setmedia|music|77.233.1.12|130.185.250.102|188.35.9.4|udp|stream|mp3|mp4|mkv|217.23.8.25|kosmowka|play|radio|95.86.32.7|184.154.202.243|livewipserver|.online)', strtolower($strURL)) === 1) {
		//unset($arrURLs[$index]);
		continue;
	}
