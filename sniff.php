...
foreach ($arrURLs as $index => $strURL) {
	...
	if (preg_match('(latinorigin|audio|setmedia|music|130.185.250.102|188.35.9.4|udp|stream|mp3|mp4|mkv|217.23.8.25|kosmowka|play|radio|95.86.32.7|184.154.202.243|livewipserver|.online)', strtolower($strURL)) === 1) {
		//unset($arrURLs[$index]);
		continue;
	}
