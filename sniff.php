...
foreach ($arrURLs as $index => $strURL) {
	...
	if (preg_match('(audio|130.185.250.102|udp|stream|mp3|mp4|mkv|217.23.8.25|kosmowka|play|radio|95.86.32.7|184.154.202.243|livewipserver|.online)', strtolower($strURL)) === 1) {
		//unset($arrURLs[$index]);
		continue;
	}
